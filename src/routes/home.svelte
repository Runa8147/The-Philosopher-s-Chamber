<script>
  ...
  import DebateComp from 'DebateComp.svelte'; // Import the Debate component
  ...
  <div class="museum-scene">
    ...
    {:else}
      <div class="museum-interior" transition:fade={{ duration: 1000 }}>
        ...
        <!-- Add the Debate component here -->
        {#if isDebating}
          <!-- Pass the debateTopic to the Debate component -->
          <DebateComp topic={debateTopic} />
        {/if}
      </div>
    {/if}
  </div>
